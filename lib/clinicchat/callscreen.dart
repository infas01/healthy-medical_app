...
class CallLogPage extends StatelessWidget {
  final List<CallLogEntry> callLog = [
    CallLogEntry(name: "Friend", time: "30 minutes ago", isMissed: false, imagePath: "assets/image/human.png"),
    CallLogEntry(
      name: "Faiqa",
      time: "2 hours ago",
      isMissed: true,
      imagePath: "assets/image/img.png",
    ),
    CallLogEntry(
      name: "Ayesha Coaching",
      time: "Yesterday",
      isMissed: false,
      imagePath: "assets/image/girl.png",
    ),
